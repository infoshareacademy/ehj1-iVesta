...
export class VehiclesHttpService {
  ...
  getAvailableVehiclesForGivenDate(date: string){
    return this.http.get<Vehicle[]>(`${VEHICLES_API_PATH}/availableVehicles/${date}`)
  }

  getAvailableVehiclesForGivenLicense(license: string){
